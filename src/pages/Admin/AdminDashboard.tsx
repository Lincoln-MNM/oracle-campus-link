...
import { Users, BookOpen, ClipboardList, Building2, TrendingUp, Award } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const departments = useMemo(() => new Set(students.map((s) => s.department)).size, [students]);
