...
const DevelopersSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-xs font-mono uppercase tracking-[0.3em]" style={{ color: "rgba(129,140,248,0.7)" }}>
          // Meet the Team
        </p>
        <h2 className="text-2xl sm:text-3xl font-bold font-display" style={{ color: "rgba(255,255,255,0.9)" }}>
          Developers
        </h2>
      </motion.div>
      ...
      <div className="relative z-10 flex flex-col items-center max-w-4xl mx-auto px-4">
        ...
        <motion.div
          ...
          animate={isInView ? { y: 0, opacity: 0.07, filter: "blur(0px)" } : {}}
        ...
        >
          <div className="flex flex-col items-center leading-[0.85]">
            {developer.name.split("").map((char, i) => (
              <span
                key={i}
                className="text-[8rem] sm:text-[10rem] md:text-[13rem] font-black font-display tracking-tighter"
                style={{ lineHeight: 0.82, color: "white" }}
              >
                {char}
              </span>
            ))}
              ...
              return (
                ...
                >
                  <motion.div
                    ...
                    className="flex items-center gap-1.5 rounded-xl border px-3 py-1.5 text-xs font-medium cursor-default shadow-lg"
                    style={{
        ...
        <div className="relative z-10 mt-8 text-center">
          ...
          <motion.p
            ...
            className="mt-3 text-sm italic max-w-xs mx-auto"
